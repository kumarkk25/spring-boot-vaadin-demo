...
public class AddressbookUI extends UI {
	...
	private void initLayout() {
		...
		// add a new footer in left panel
		HorizontalLayout bottomLeftFooterLayout = new HorizontalLayout();
		//bottomLeftFooterLayout.setSizeFull();
...
//		link.setWidth("100%");
	...
	private void initEditor() {
		...
		for (String fieldName : fieldNames) {
			...
			field.setDescription("Enter the " + fieldName + " here");
